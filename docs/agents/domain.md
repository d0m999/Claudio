...
Claudio uses a single-context layout:

- `CONTEXT.md` at the repo root defines the shared domain vocabulary.
- `docs/adr/` contains architectural decisions for the whole repository.
- `helper/` and `gui/` share this context rather than maintaining separate context maps.
